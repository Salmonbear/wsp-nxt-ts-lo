...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: hquASchwDaIy/css
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__m1G5J)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__hovXc)}
              />
            </React.Fragment>
          ),
          value: args.children
