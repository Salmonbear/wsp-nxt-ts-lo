...
import sty from "./Plasmic_1SpeechWizard.module.css"; // plasmic-import: SW7dk3xEW-JW/css
...
export type Plasmic_1SpeechWizard__VariantMembers = {};
export type Plasmic_1SpeechWizard__VariantsArgs = {};
type VariantPropType = keyof Plasmic_1SpeechWizard__VariantsArgs;
export const Plasmic_1SpeechWizard__VariantProps = new Array<VariantPropType>();

export type Plasmic_1SpeechWizard__ArgsType = {};
type ArgPropType = keyof Plasmic_1SpeechWizard__ArgsType;
export const Plasmic_1SpeechWizard__ArgProps = new Array<ArgPropType>();

export type Plasmic_1SpeechWizard__OverridesType = {
  root?: Flex__<"div">;
...
export interface Default_1SpeechWizardProps {}
...
function Plasmic_1SpeechWizard__RenderFunc(props: {
  variants: Plasmic_1SpeechWizard__VariantsArgs;
  args: Plasmic_1SpeechWizard__ArgsType;
  overrides: Plasmic_1SpeechWizard__OverridesType;
  forNode?: string;
}) {
    ...
    <React.Fragment>
      <Head>
        ...
        <meta
          key="og:image"
          property="og:image"
          content={Plasmic_1SpeechWizard.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__ruZrM)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.column___0Kh4S)}>
                <PlasmicImg__
...
const PlasmicDescendants = {
  ...
  section: ["section", "embedHtml", "columns", "freeBox", "button", "img"],
  embedHtml: ["embedHtml"],
  columns: ["columns", "freeBox", "button", "img"],
  freeBox: ["freeBox"],
  button: ["button"],
  img: ["img"],
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  Plasmic_1SpeechWizard__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<Plasmic_1SpeechWizard__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      Plasmic_1SpeechWizard__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: Plasmic_1SpeechWizard__ArgProps,
          internalVariantPropNames: Plasmic_1SpeechWizard__VariantProps
        }),
      [props, nodeName]
    );
    return Plasmic_1SpeechWizard__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "Plasmic_1SpeechWizard";
  } else {
    func.displayName = `Plasmic_1SpeechWizard.${nodeName}`;
  }
  return func;
}

export const Plasmic_1SpeechWizard = Object.assign(
  // Top-level Plasmic_1SpeechWizard renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for Plasmic_1SpeechWizard
    internalVariantProps: Plasmic_1SpeechWizard__VariantProps,
    internalArgProps: Plasmic_1SpeechWizard__ArgProps,
...
export default Plasmic_1SpeechWizard;
/* prettier-ignore-end */
