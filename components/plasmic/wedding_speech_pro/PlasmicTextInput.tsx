...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: TS3ZiMBhGoq/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__uCOnP)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__pa9B)}
              role={"img"}
            />
          ),
